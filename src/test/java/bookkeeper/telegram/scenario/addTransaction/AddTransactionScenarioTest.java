...
class AddTransactionScenarioTest {
    ...
    private static Collection<String> validTinkoffInputs() {
        return List.of(
            ...
            "Зачислили проценты на вклад — 1 562,15 RUB: t.tb.ru/abcdef",
    ...
    private static Collection<String> validSberInputs() {
        return List.of(
            ...
            "Счёт карты MIR-1234 15:10 Перевод по СБП из Омега-Банк +123р от ДАНИИЛ К. Баланс: 656.23р «Перевод денежных средств»",
            ...
            "Накопит. счет Премьер *1234 Выплатили проценты 377,13р. Баланс: 3 453,10р."
        );
    }
    ...
    private static Collection<String> emptySberInputs() {
        return List.of(
            ...
            "В августе вам начислили 50 бонусов Спасибо. Подробнее s.sber.ru/abcdef",
