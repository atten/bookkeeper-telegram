...
class TinkoffPurchaseSmsWithDateParserTest {
    ...
    void parse() throws ParseException {
        TinkoffPurchaseSmsWithDateParser parser = new TinkoffPurchaseSmsWithDateParser();
        TinkoffPurchaseSms sms = parser.parse("Покупка 17.07.2023. Карта *0964. 56 RUB. MOS.TRANSP. Доступно 499.28 RUB");

        TinkoffPurchaseSmsWithDate referenceSms = new TinkoffPurchaseSmsWithDate();
        ...
        referenceSms.merchantTag = "MOS.TRANSP";
